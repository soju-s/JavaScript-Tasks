...
//   7. Refer restaurant .js test –file to answer the following
  // a. Display all restaurants name
  console.log('resturants name =');
nme=restuarants.map(a=>a.name)
console.log(nme);

  // b. Display the operating hours of restaurant id:4 

 console.log('operating hours of resturant id 4=');
 console.log(restuarants.find(a=>a.id==4).operating_hours);
  // c. Display the comments provided by customer Steph for restaurant Emily
console.log('comments provided by customer steph for resturant Emily=');
 z= restuarants.find(a=>a.name=='Emily').reviews.flat(Infinity).find(b=>b.name=='Steph').comments
 console.log(z);


  // d. Display all restaurants name whose cuisine_type is Asian

  console.log('resturants name whose cuisine type is asian =');
restuarants.filter(a=>a.cuisine_type=='Asian').forEach(item=>console.log(item.name));

  // e. Display all restaurants whose neighborhood is Brooklyn

  console.log('resturants whose neighborhood is brooklyn is');
console.log(  restuarants.find(a=>a.neighborhood=='Brooklyn').name);